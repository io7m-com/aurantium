...
public final class AUValidators
{
  /**
   * The main validator factory.
   */
  ...
  public Optional<AUValidatorFactoryType> findValidatorFactoryFor(
    final AUVersion version)
  {
    Objects.requireNonNull(version, "version");

    final var loader =
      ServiceLoader.load(AUValidatorFactoryType.class);
    final var iterator =
      loader.iterator();
    final var candidates =
      new ArrayList<AUValidatorFactoryType>();
