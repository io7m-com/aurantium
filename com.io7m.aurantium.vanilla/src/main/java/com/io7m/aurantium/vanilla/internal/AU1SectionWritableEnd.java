...
import com.io7m.aurantium.api.AUSectionWritableEndType;
...
public final class AU1SectionWritableEnd extends AU1SectionWritableAbstract
  implements AUSectionWritableEndType
{
  /**
   * A writable end section.
   *
