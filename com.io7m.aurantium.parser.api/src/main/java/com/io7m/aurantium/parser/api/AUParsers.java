...
public final class AUParsers
{
  private final AUProbes probes;
  ...
  public Optional<AUParserFactoryType> findParserFactoryFor(
    final AUVersion version)
  {
    Objects.requireNonNull(version, "version");

    final var loader =
      ServiceLoader.load(AUParserFactoryType.class);
    final var iterator =
      loader.iterator();
    final var candidates =
      new ArrayList<AUParserFactoryType>();
  ...
  private record FindResult(
    AUVersion version,
    Optional<AUParserFactoryType> factory)
  {
