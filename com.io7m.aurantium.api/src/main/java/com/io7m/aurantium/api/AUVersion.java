...
public record AUVersion(
  int major,
  int minor)
  implements Comparable<AUVersion>
{
  ...
  @Override
  public int compareTo(final AUVersion other)
  {
    return ((Comparator<AUVersion>) (ox, oy) -> {
