...
public final class AUClipDeclarationTest
{
  @Test
  public void testClipDeclarationNonZero0()
  {
    final var ex =
  ...
  @Test
  public void testClipDeclarationNonZero1()
  {
    final var ex =
      assertThrows(IllegalArgumentException.class, () -> {
        new AUClipDeclaration(
  ...
  @Test
  public void testClipDeclarationNonZero2()
  {
    final var ex =
      assertThrows(IllegalArgumentException.class, () -> {
        new AUClipDeclaration(
