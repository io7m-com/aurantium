...
public final class AUTestDirectories
{
  private static final Logger LOGGER =
    LoggerFactory.getLogger(AUTestDirectories.class);

  private AUTestDirectories()
  {
  ...
  public static Path resourceOf(
    ...
    throws IOException
  {
    final var internal = String.format("/com/io7m/aurantium/tests/%s", name);
